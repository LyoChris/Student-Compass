...
public class UpdateItemRequestDto {
    ...
    @Size(max = 100)
    @NullOrNotBlank(message = "title must contain non-whitespace characters")
    ...
    @Size(max = 2000)
    @NullOrNotBlank(message = "description must contain non-whitespace characters")
    ...
    private List<@NullOrNotBlank(message = "tag must contain non-whitespace characters") @Size(max = 100) String> tags;
    ...
    private List<@NullOrNotBlank(message = "imageUrl must contain non-whitespace characters") @Size(max = 512) String> imageUrls;
}
