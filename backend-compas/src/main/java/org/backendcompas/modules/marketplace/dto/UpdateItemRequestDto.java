...
public class UpdateItemRequestDto {
    ...
    private List<@Pattern(regexp = ".*\\S.*", message = "tag must contain non-whitespace characters") @Size(max = 100) String> tags;
    ...
    private List<@Pattern(regexp = ".*\\S.*", message = "imageUrl must contain non-whitespace characters") @Size(max = 512) String> imageUrls;
}
